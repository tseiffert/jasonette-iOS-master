...
+ (void)setStatusBarBackgroundColor:(UIColor *)color {
    ...
    if ([statusBar respondsToSelector:@selector(setBackgroundColor:)]) {
     ...
     https://stackoverflow.com/questions/56651245/how-to-change-the-status-bar-background-color-and-text-color-on-ios-13/56887647#56887647
    ...
    if (@available(iOS 13, *))
    {
        ...
        {
            statusBar.backgroundColor = color;
            // bug with dark mode, text is not visible
            //statusBar.tintColor = UIColor.grayColor;
